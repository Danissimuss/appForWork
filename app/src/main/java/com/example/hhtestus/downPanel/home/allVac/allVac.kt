...
fun allVac(navController: NavController, viewModel: SharedViewModel) {
    ...
    val formatVac = viewModel.vacancies.value?.size?.let { mainContent.formatVac(it) }
        ?: "Вакансий не обнаружено"
    ...
    Column(
        ...
        Search(
            searchIcon = backIcon, searchText = "Должность по подходящим вакан...",
        ...
        Row(
            ...
            Text(
                text = "По соответствию", style = Standart, color = Blue,
                modifier = Modifier
                    .padding(end = 6.dp)
